...
export const TableContainer = styled.div<styleProps>`
  ...
  max-width: ${(props) => (props.numPlayers > 4 ? "75vh" : props.numPlayers > 2 ? "65vh" : "55vh")};
  border-radius: 15px;
...
export const HeadRow = styled.div<styleProps>`
  ...
  height: 2.5rem;
  display: grid;
  grid-template-columns: 0.4fr repeat(${(props) => props.numPlayers}, 0.2fr) 0.25fr;
...
export const Cell = styled.div<cellProps>`
  ...
  background-color: ${(props) =>
    props.rowIndex === props.cellIndex && props.rowIndex !== 0 ? "#d5d3d3" : ""};
