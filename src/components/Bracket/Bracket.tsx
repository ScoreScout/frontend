...
const BracketMatch = ({ matchId, startPosition, endPosition, stageNumber }: BracketMatchProps) : React.JSX.Element => {
		...
		<>
			<>
				...
				<StyledStageItem
					...
					$isSecondPlayer={true}
				>
					{match.firstPlayer !== undefined && match.secondPlayer !== undefined && !match.isFinished && (
						<StyledMatchTrigger
							onClick={() => {
